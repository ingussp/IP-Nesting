...
# Coordinate nesting settings, material/part tables, preview editing and Deepnest execution.
class NestingTaskPanel:
    ...
    # Validate material/part rows, export the job and start asynchronous Deepnest result
    # processing.
    def execute_nesting(self):
        """
        Validate material/part rows, write the job files and start Deepnest.
    ...
    # Restore dimensions, display units, strategy, CPU selection and Deepnest settings.
